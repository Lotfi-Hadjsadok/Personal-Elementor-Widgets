...
class Elementor_Product_Price extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'landing_master_product_price';
	}

	public function get_title() {
		return esc_html__( 'Price', 'textdomain' );
	}
	...
	protected function render() {
		...
		echo $settings['before'] . ' <span class="price">' . get_field( 'price' ) . '</span> ' . $settings['after'];
	}
